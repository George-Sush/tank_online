...
class Game(SqlAlchemyBase):
    ...
    flag = sqlalchemy.Column(sqlalchemy.Boolean, default=True)  # тут кто ходит, a на следующей номер игрока, который
    flag_win = sqlalchemy.Column(sqlalchemy.Integer, default=0)  # победил (если 0, то ещё такового нет)
